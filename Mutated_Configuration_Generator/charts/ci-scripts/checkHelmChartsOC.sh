...
function deployCore {
  ...
  helm install basic oai-5g-core/oai-5g-basic -n $namespace --set global.kubernetesDistribution=Openshift
  sleep 1
...
function useCaseOneTesting {
  ...
  helm install gnb oai-5g-ran/oai-gnb -n $namespace --set kubernetesDistribution=Openshift
  ...
  if [[ $check == "KO" ]]; then
    echo "----------NGAP Setup: KO ----------"
    kubectl logs -n $namespace $(kubectl get pods -n $namespace | grep 'oai-gnb'| awk '{print $1}')
    exit 1
  fi
  for n in {1..5};
  do
  ...
  sleep 2
  helm install nrue oai-5g-ran/oai-nr-ue -n $namespace --set kubernetesDistribution=Openshift
  ...
  if [[ $check == "KO" ]]; then
    ...
    kubectl logs -n $namespace $(kubectl get pods -n $namespace  -l app.kubernetes.io/name=oai-nr-ue | grep 'nr-ue' | awk '{print $1}')
    exit 1
  fi
...
function useCaseTwoTesting {
  ...
  helm install cu oai-5g-ran/oai-cu -n $namespace --set kubernetesDistribution=Openshift
  ...
  helm install du oai-5g-ran/oai-du -n $namespace --set kubernetesDistribution=Openshift
...
function useCaseThreeTesting {
  ...
  helm install cucp oai-5g-ran/oai-cu-cp -n $namespace --set kubernetesDistribution=Openshift
  ...
  helm install cuup oai-5g-ran/oai-cu-up -n $namespace --set kubernetesDistribution=Openshift
