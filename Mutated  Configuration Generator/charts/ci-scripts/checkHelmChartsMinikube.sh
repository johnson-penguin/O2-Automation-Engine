...
function deployCore {
  ...
  helm install basic oai-5g-core/oai-5g-basic -n $namespace
  sleep 1
...
function useCaseOneTesting {
  ...
  helm install gnb oai-5g-ran/oai-gnb -n $namespace
  ...
  sleep 2
  helm install nrue oai-5g-ran/oai-nr-ue -n $namespace
...
function useCaseTwoTesting {
  ...
  helm install cu oai-5g-ran/oai-cu -n $namespace
  ...
  helm install du oai-5g-ran/oai-du -n $namespace
...
function useCaseThreeTesting {
  ...
  helm install cucp oai-5g-ran/oai-cu-cp -n $namespace
  ...
  helm install cuup oai-5g-ran/oai-cu-up -n $namespace
