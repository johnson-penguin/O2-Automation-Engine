...
# 🛰️ Parent Helm Charts for Deploying Mini OAI-5G Core Network

This guide explains how to deploy the OpenAirInterface (OAI) 5G Core using Helm charts.

## 📦 Components in the Mini Deployment

The mini 5G Core deployment includes the following network functions (NFs):
...
4. OAI-UPF — User Plane Function
5. MySQL — Subscriber database
6. Traffic Server - Just a simple iperf3 server
