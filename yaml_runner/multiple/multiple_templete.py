...
LOG_DIR = "/home/johnson/O2-Automation-Engine/yaml_runner/multiple/multiple_templete_logs"
...
def main():
    ...
    for yaml_file in yaml_files:
        ...
        log_dir = f"{LOG_DIR}/test_{datetime.now().strftime('%m%d_%H%M%S')}_{case_name.replace('.yaml', '')}"
